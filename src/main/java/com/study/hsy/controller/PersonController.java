...
public class PersonController {
    ...
    public String getUserinfo(Model model) {
        ...
        exp.add("K-Digital 신기술 실무인재양성 해커톤에 참가하여 '수소경제 활성화'를 주제로 수소차 및 수소충전소에 대한 데이터를 분석하여 수소차 유저들에게 필요한 정보(충전소 위치, 수소차 지원 정책 등)을 제공하는 웹서비스를 프로토타입까지 개발. 아쉽게도 예선 탈락");
        expMap.put("2", exp);
        exp.clear();
